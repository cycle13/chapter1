...
p6 = [800000, 2000000, 4000000] #albedoDecayRate  |       1.0d+6 |       0.1d+6 |       5.0d+6 $$$$$$ 3: 0.8d+6 | 2d+6 | 4.0d+6
...
paramfile = Dataset("summa_zParamTrial_144hru_V.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
...
#varcheck = Dataset ('summa_zParamTrial_144hru_V.nc')
