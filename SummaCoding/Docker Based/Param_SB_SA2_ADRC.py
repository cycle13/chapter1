...
p6 = [0.25]#,0.35,0.50] #fixedThermalCond_snow
...
paramfile = Dataset("summa_zParamTrial_constantDecayRate_SA2.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
