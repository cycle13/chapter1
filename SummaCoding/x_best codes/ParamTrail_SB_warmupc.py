...
hru_names1 = np.reshape(hru_names,(288,1))
hru_names_df = pd.DataFrame (hru_names1)
# %store hruidxID
#%%
param_nam_list = ['albedoDecayRate', 'albedoMinSpring', 'albedoMax', 'z0Snow', 'windReductionParam'] 
...
paramfile = Dataset("summa_zParamTrial_constantDecayRate.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
...
f1 = Dataset('summa_zParamTrial_constant.nc')
...
local_atrbt = Dataset("summa_zLocalAttributes_senatorSheltered_c.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
local_atrbt.close()
#%%
laCheck = Dataset('summa_zLocalAttributes_senatorSheltered_c.nc')
...
in_condi = Dataset("summa_zInitialCond_c.nc",'w',format='NETCDF3_CLASSIC')
#print ic.variables.keys()
...
in_condi.close()
#%%
iccheck = Dataset("summa_zInitialCond_c.nc")
