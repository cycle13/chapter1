...
observation = Dataset("C:/1UNR-University Folder/Dissertation/Chapter 1-Snowmelt/SummaCoding/Output-SAStep2/senatorBeck_FD.nc")
...
observ_df_int = np.column_stack([observation['skinTemp'],observation['snowDepth'],observation['swRadUp'],observation['swRadDown'],observation['lwRadDown'],observation['hiRH'], observation['loRH']])
observ_df = pd.DataFrame (observ_df_int, columns=['skinTemp','snowDepth','swRadUp','swRadDown','lwRadDown','hiRH', 'loRH'])
...
all_out_name = ['Ac_ASlouis_SWRclm_TCSjrdn','Ac_ASlouis_SWRclm_TCSsmnv','Ac_ASlouis_SWRueb_TCSjrdn','Ac_ASlouis_SWRueb_TCSsmnv',
...
#%%
mod_swe_mm = Av_ASstd_SWRclm_TCSsmnv2.variables['scalarSWE'][:]
