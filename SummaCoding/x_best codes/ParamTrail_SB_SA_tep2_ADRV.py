...
p1 = [700000, 1000000, 3000000] #albedoDecayRate
p2 = [0.8, 0.9, 0.95] #albedoMaxVisible 
p3 = [0.6, 0.68, 0.75] #albedoMinVisible  
...
# %store hruidxID
#%%
param_nam_list = ['albedoDecayRate', 'albedoMaxVisible', 'albedoMinVisible', 'z0Snow', 'windReductionParam', 'fixedThermalCond_snow'] 
...
paramfile = Dataset("summa_zParamTrial_variableDecayRate_SA2.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
...
local_atrbt = Dataset("summa_zLocalAttributes_senatorSheltered_SA2.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
local_atrbt.close()
#%%
laCheck = Dataset('summa_zLocalAttributes_senatorSheltered_SA2.nc')
