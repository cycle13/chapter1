...
output_sb_Av_ASl_SWRc_TCj = Dataset("Av_ASlouis_SWRueb_TCSsmnv_2010-2011_senatorVariableDecayRate_1.nc")
mod_swe_mm = output_sb_Av_ASl_SWRc_TCj.variables['scalarSWE'][:]

#Av_ASstd_SWRclm_TCSsmnv_2010-2011_senatorVariableDecayRate_1.nc
#Ac_ASlouis_SWRclm_TCSjrdn_2010-2011_senatorConstantDecayRate_1.nc
#Ac_ASlouis_SWRclm_TCSsvp2_2010-2011_senatorConstantDecayRate_1.nc
#Ac_ASlouis_SWRueb_TCSjrdn_2010-2011_senatorConstantDecayRate_1.nc
#Ac_ASlouis_SWRueb_TCSsmnvp2_2010-2011_senatorConstantDecayRate_1.nc
#Ac_ASstd_SWRclm_TCSjrdn_2010-2011_senatorConstantDecayRate_1.nc
#Ac_ASstd_SWRclm_TCSsmnvp2_2010-2011_senatorConstantDecayRate_1.nc
#Ac_ASstd_SWRueb_TCSjrdn_2010-2011_senatorConstantDecayRate_1.nc
#Ac_ASstd_SWRueb_TCSsmnvp2_2010-2011_senatorConstantDecayRate_1.nc
#Av_ASlouis_SWRclm_TCSjrdn_2010-2011_senatorVariableDecayRate_1.nc
#Av_ASlouis_SWRclm_TCSsmnv_2010-2011_senatorVariableDecayRate_1.nc
#Av_ASlouis_SWRueb_TCSjrdn_2010-2011_senatorVariableDecayRate_1.nc
#Av_ASlouis_SWRueb_TCSsmnv_2010-2011_senatorVariableDecayRate_1.nc
#Av_ASstd_SWRclm_TCSjrdn_2010-2011_senatorVariableDecayRate_1.nc

#for i in output_sb_Av_ASl_SWRc_TCj.variables:
#    print i

hru_num = np.size(output_sb_Av_ASl_SWRc_TCj.variables['hru'][:])

#%% output time step
TimeSb = output_sb_Av_ASl_SWRc_TCj.variables['time'][:] # get values
t_unitSb = output_sb_Av_ASl_SWRc_TCj.variables['time'].units # get unit  "days since 1950-01-01T00:00:00Z"

try :

    t_cal = output_sb_Av_ASl_SWRc_TCj.variables['time'].calendar
...
out1_df_int = np.column_stack([output_sb_Av_ASl_SWRc_TCj['scalarSnowDepth'][:,0],output_sb_Av_ASl_SWRc_TCj['scalarSurfaceTemp'][:,0],output_sb_Av_ASl_SWRc_TCj['scalarSenHeatTotal'][:,0],output_sb_Av_ASl_SWRc_TCj['scalarLatHeatTotal'][:,0]])

snowdepth_Av_ASl_SWRc_TCj = output_sb_Av_ASl_SWRc_TCj.variables['scalarSnowDepth'][:]
