...
def plotBoxPlotin2panels(d11_dry,d11_wet,savepath,color,ylabel,text_position,text_color,bottom1,top1,roundn): #
    ...
    y_tick = np.round(np.arange(bottom1, top1+(top1-bottom1)/6.,(top1-bottom1)/6.),roundn)
    saax[0].set_ylabel(ylabel, fontsize=44)
    saax[0].set_yticklabels(y_tick,fontsize=40)
    ...
    saax[1].set_yticklabels(y_tick,fontsize=40)
    saax[1].set_xticklabels(x11, fontsize=50, rotation = '25')#position,
    saax[1].set_ylim([bottom1, top1])
    
    plt.savefig(savepath)

d110_dry = [snowFraction_h_swe_dry[0],snowFraction_T_swe_dry[0],
            snowFraction_T_al_swe_dry[0],snowFraction_T_al_P_swe_dry[0],
...
d110_wet = [snowFraction_h_swe_wet[0],snowFraction_T_swe_wet[0], 
            snowFraction_T_al_swe_wet[0],snowFraction_T_al_P_swe_wet[0],
...
savepath1 = 'C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_accum_2panel3.png'
ylabel1 = 'Annual fraction of snow to total precipitation'
color1 = ['navy','deepskyblue','lightcyan']
text_position1 = [1.09, 1.09, 1.09, 1.15, 1.10]
plotBoxPlotin2panels(d110_dry,d110_wet,savepath1,color1,ylabel1,text_position1,'red',0.45,1.05,2)
