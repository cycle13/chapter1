...
snowFraction_h_swe_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_dic,snow_h_swe_dic,rain_h_swe_dic)    
...
snowFraction_h_swe_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_dry],ignore_index=True)
snowFraction_h_swe_mr_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_dry],ignore_index=True)
snowFraction_h_swe_mr_sst_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_sst_dry],ignore_index=True)
snowFraction_h_swe_mr_sst_cc_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_sst_cc_dry],ignore_index=True)

snowFraction_T_swe_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_dry],ignore_index=True)
snowFraction_T_swe_mr_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_dry],ignore_index=True)
snowFraction_T_swe_mr_sst_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_sst_dry],ignore_index=True)
snowFraction_T_swe_mr_sst_cc_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_sst_cc_dry],ignore_index=True)

snowFraction_T_al_swe_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_dry],ignore_index=True)
snowFraction_T_al_swe_mr_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_dry],ignore_index=True)
snowFraction_T_al_swe_mr_sst_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_sst_dry],ignore_index=True)
snowFraction_T_al_swe_mr_sst_cc_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_sst_cc_dry],ignore_index=True)

snowFraction_T_al_P_swe_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_dry],ignore_index=True)
snowFraction_T_al_P_swe_mr_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_dry],ignore_index=True)
snowFraction_T_al_P_swe_mr_sst_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_sst_dry],ignore_index=True)
snowFraction_T_al_P_swe_mr_sst_cc_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_sst_cc_dry],ignore_index=True)



snowFraction_h_swe_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_wet],ignore_index=True)
snowFraction_h_swe_mr_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_wet],ignore_index=True)
snowFraction_h_swe_mr_sst_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_sst_wet],ignore_index=True)
snowFraction_h_swe_mr_sst_cc_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_sst_cc_wet],ignore_index=True)

snowFraction_T_swe_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_wet],ignore_index=True)
snowFraction_T_swe_mr_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_wet],ignore_index=True)
snowFraction_T_swe_mr_sst_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_sst_wet],ignore_index=True)
snowFraction_T_swe_mr_sst_cc_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_sst_cc_wet],ignore_index=True)

snowFraction_T_al_swe_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_wet],ignore_index=True)
snowFraction_T_al_swe_mr_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_wet],ignore_index=True)
snowFraction_T_al_swe_mr_sst_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_sst_wet],ignore_index=True)
snowFraction_T_al_swe_mr_sst_cc_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_sst_cc_wet],ignore_index=True)

snowFraction_T_al_P_swe_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_wet],ignore_index=True)
snowFraction_T_al_P_swe_mr_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_wet],ignore_index=True)
snowFraction_T_al_P_swe_mr_sst_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_sst_wet],ignore_index=True)
snowFraction_T_al_P_swe_mr_sst_cc_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_sst_cc_wet],ignore_index=True)
