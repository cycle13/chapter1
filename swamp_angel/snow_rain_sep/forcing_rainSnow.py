...
params_sa = hruid_dic['ljc'] 
hruidxID = hruid_dic['ljc']
hru_num = np.size(hruidxID)

#%% #Swamp Angel forcing data
with open("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/swamp_angel_forcingdata2_corrected_precipCalib_final_L_h.csv") as safd:
...
#%% make new nc file
new_fc_sa = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/SwampAngel_forcingD_ljc_h.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
new_fc_sa.close()
#%%
testfd = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/SwampAngel_forcingD_ljc_h.nc")
