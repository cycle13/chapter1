...
def calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_dic,snow_h_swe_dic,rain_h_swe_dic):
    snowFraction_h_swe_dry = [] #np.zeros((2,1))#(len(param_dic.keys()[:])    {keysss : np.array([0]) for keysss in param_dic.keys()[:]} 
        ...
        for ts in range (len(snow_h_swe_dic[param_dic.keys()[pdm]])):
            ...
            for precip in range (8760):
                if (snow_h_swe_dic[param_dic.keys()[pdm]][ts][precip]+rain_h_swe_dic[param_dic.keys()[pdm]][ts][precip])>0:
                    ...
                    snowFractionParam.append(snwfrac)
...
def calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_dic,snow_h_swe_dic,rain_h_swe_dic):
    snowFraction_h_swe_wet = [] #np.zeros((2,1))#(len(param_dic.keys()[:])    {keysss : np.array([0]) for keysss in param_dic.keys()[:]} 
     
    for pdm in range(len(param_dic.keys())):
        snowFractionTimeSeries = np.zeros((len(snow_h_swe_dic[param_dic.keys()[pdm]]),1)) #
        for ts in range (len(snow_h_swe_dic[param_dic.keys()[pdm]])):
            snowFractionParam = []
            for precip in (np.arange(8760,16081)):
                if (snow_h_swe_dic[param_dic.keys()[pdm]][ts][precip]+rain_h_swe_dic[param_dic.keys()[pdm]][ts][precip])>0:
                    snwfrac = snow_h_swe_dic[param_dic.keys()[pdm]][ts][precip]/(snow_h_swe_dic[param_dic.keys()[pdm]][ts][precip]+rain_h_swe_dic[param_dic.keys()[pdm]][ts][precip])
                    snowFractionParam.append(snwfrac)
            snowFractionParam_mean = np.mean(snowFractionParam)
...
#snowFraction_h_swe2_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_dic,snow_h_swe_dic,rain_h_swe_dic)    
#snowFraction_h_swe_mr_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_dic,snow_h_swe_mr_dic,rain_h_swe_mr_dic)    
#snowFraction_h_swe_mr_sst_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_sst_dic,snow_h_swe_mr_sst_dic,rain_h_swe_mr_sst_dic)    
#snowFraction_h_swe_mr_sst_cc_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_sst_cc_dic,snow_h_swe_mr_sst_cc_dic,rain_h_swe_mr_sst_cc_dic)    
#
#snowFraction_T_swe2_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_dic,snow_T_swe_dic,rain_T_swe_dic)    
#snowFraction_T_swe_mr_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_dic,snow_T_swe_mr_dic,rain_T_swe_mr_dic)    
#snowFraction_T_swe_mr_sst_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_sst_dic,snow_T_swe_mr_sst_dic,rain_T_swe_mr_sst_dic)    
#snowFraction_T_swe_mr_sst_cc_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_sst_cc_dic,snow_T_swe_mr_sst_cc_dic,rain_T_swe_mr_sst_cc_dic)    
#
#snowFraction_T_al_swe2_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_dic,snow_T_al_swe_dic,rain_T_al_swe_dic)    
#snowFraction_T_al_swe_mr_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_dic,snow_T_al_swe_mr_dic,rain_T_al_swe_mr_dic)    
#snowFraction_T_al_swe_mr_sst_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_sst_dic,snow_T_al_swe_mr_sst_dic,rain_T_al_swe_mr_sst_dic)    
#snowFraction_T_al_swe_mr_sst_cc_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_sst_cc_dic,snow_T_al_swe_mr_sst_cc_dic,rain_T_al_swe_mr_sst_cc_dic)    
#
#snowFraction_T_al_P_swe2_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_dic,snow_T_al_P_swe_dic,rain_T_al_P_swe_dic)    
#snowFraction_T_al_P_swe_mr_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_dic,snow_T_al_P_swe_mr_dic,rain_T_al_P_swe_mr_dic)    
#snowFraction_T_al_P_swe_mr_sst_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_sst_dic,snow_T_al_P_swe_mr_sst_dic,rain_T_al_P_swe_mr_sst_dic)    
#snowFraction_T_al_P_swe_mr_sst_cc_dry = calculatingSnowFractionfromSnowfallAndRainfall_dryYear(param_swe_mr_sst_cc_dic,snow_T_al_P_swe_mr_sst_cc_dic,rain_T_al_P_swe_mr_sst_cc_dic)    
#
#snowFraction_h_swe2_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_dic,snow_h_swe_dic,rain_h_swe_dic)    
#snowFraction_h_swe_mr_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_dic,snow_h_swe_mr_dic,rain_h_swe_mr_dic)    
#snowFraction_h_swe_mr_sst_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_sst_dic,snow_h_swe_mr_sst_dic,rain_h_swe_mr_sst_dic)    
#snowFraction_h_swe_mr_sst_cc_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_sst_cc_dic,snow_h_swe_mr_sst_cc_dic,rain_h_swe_mr_sst_cc_dic)    
#
#snowFraction_T_swe2_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_dic,snow_T_swe_dic,rain_T_swe_dic)    
#snowFraction_T_swe_mr_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_dic,snow_T_swe_mr_dic,rain_T_swe_mr_dic)    
#snowFraction_T_swe_mr_sst_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_sst_dic,snow_T_swe_mr_sst_dic,rain_T_swe_mr_sst_dic)    
#snowFraction_T_swe_mr_sst_cc_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_sst_cc_dic,snow_T_swe_mr_sst_cc_dic,rain_T_swe_mr_sst_cc_dic)    
#
#snowFraction_T_al_swe2_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_dic,snow_T_al_swe_dic,rain_T_al_swe_dic)    
#snowFraction_T_al_swe_mr_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_dic,snow_T_al_swe_mr_dic,rain_T_al_swe_mr_dic)    
#snowFraction_T_al_swe_mr_sst_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_sst_dic,snow_T_al_swe_mr_sst_dic,rain_T_al_swe_mr_sst_dic)    
#snowFraction_T_al_swe_mr_sst_cc_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_sst_cc_dic,snow_T_al_swe_mr_sst_cc_dic,rain_T_al_swe_mr_sst_cc_dic)    
#
#snowFraction_T_al_P_swe2_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_dic,snow_T_al_P_swe_dic,rain_T_al_P_swe_dic)    
#snowFraction_T_al_P_swe_mr_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_dic,snow_T_al_P_swe_mr_dic,rain_T_al_P_swe_mr_dic)    
#snowFraction_T_al_P_swe_mr_sst_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_sst_dic,snow_T_al_P_swe_mr_sst_dic,rain_T_al_P_swe_mr_sst_dic)    
#snowFraction_T_al_P_swe_mr_sst_cc_wet = calculatingSnowFractionfromSnowfallAndRainfall_wetYear(param_swe_mr_sst_cc_dic,snow_T_al_P_swe_mr_sst_cc_dic,rain_T_al_P_swe_mr_sst_cc_dic)    

#%% saving snow fraction
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_dry',snowFraction_h_swe2_dry)
snowFraction_h_swe2_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_dry',snowFraction_h_swe_mr_dry)
snowFraction_h_swe_mr_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_sst_dry',snowFraction_h_swe_mr_sst_dry)
snowFraction_h_swe_mr_sst_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_sst_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_sst_cc_dry',snowFraction_h_swe_mr_sst_cc_dry)
snowFraction_h_swe_mr_sst_cc_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_sst_cc_dry.npy')

#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_dry',snowFraction_T_swe2_dry)
snowFraction_T_swe2_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_dry',snowFraction_T_swe_mr_dry)
snowFraction_T_swe_mr_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_sst_dry',snowFraction_T_swe_mr_sst_dry)
snowFraction_T_swe_mr_sst_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_sst_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_sst_cc_dry',snowFraction_T_swe_mr_sst_cc_dry)
snowFraction_T_swe_mr_sst_cc_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_sst_cc_dry.npy')

#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_dry',snowFraction_T_al_swe2_dry)
snowFraction_T_al_swe2_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_dry',snowFraction_T_al_swe_mr_dry)
snowFraction_T_al_swe_mr_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_sst_dry',snowFraction_T_al_swe_mr_sst_dry)
snowFraction_T_al_swe_mr_sst_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_sst_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_sst_cc_dry',snowFraction_T_al_swe_mr_sst_cc_dry)
snowFraction_T_al_swe_mr_sst_cc_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_sst_cc_dry.npy')

#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_dry',snowFraction_T_al_P_swe2_dry)
snowFraction_T_al_P_swe2_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_dry',snowFraction_T_al_P_swe_mr_dry)
snowFraction_T_al_P_swe_mr_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_sst_dry',snowFraction_T_al_P_swe_mr_sst_dry)
snowFraction_T_al_P_swe_mr_sst_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_sst_dry.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_sst_cc_dry',snowFraction_T_al_P_swe_mr_sst_cc_dry)
snowFraction_T_al_P_swe_mr_sst_cc_dry_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_sst_cc_dry.npy')



#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_wet',snowFraction_h_swe2_wet)
snowFraction_h_swe2_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_wet',snowFraction_h_swe_mr_wet)
snowFraction_h_swe_mr_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_sst_wet',snowFraction_h_swe_mr_sst_wet)
snowFraction_h_swe_mr_sst_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_sst_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_sst_cc_wet',snowFraction_h_swe_mr_sst_cc_wet)
snowFraction_h_swe_mr_sst_cc_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_h_swe_mr_sst_cc_wet.npy')

#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_wet',snowFraction_T_swe2_wet)
snowFraction_T_swe2_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_wet',snowFraction_T_swe_mr_wet)
snowFraction_T_swe_mr_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_sst_wet',snowFraction_T_swe_mr_sst_wet)
snowFraction_T_swe_mr_sst_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_sst_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_sst_cc_wet',snowFraction_T_swe_mr_sst_cc_wet)
snowFraction_T_swe_mr_sst_cc_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_swe_mr_sst_cc_wet.npy')

#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_wet',snowFraction_T_al_swe2_wet)
snowFraction_T_al_swe2_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_wet',snowFraction_T_al_swe_mr_wet)
snowFraction_T_al_swe_mr_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_sst_wet',snowFraction_T_al_swe_mr_sst_wet)
snowFraction_T_al_swe_mr_sst_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_sst_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_sst_cc_wet',snowFraction_T_al_swe_mr_sst_cc_wet)
snowFraction_T_al_swe_mr_sst_cc_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_swe_mr_sst_cc_wet.npy')

#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_wet',snowFraction_T_al_P_swe2_wet)
snowFraction_T_al_P_swe2_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_wet',snowFraction_T_al_P_swe_mr_wet)
snowFraction_T_al_P_swe_mr_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_sst_wet',snowFraction_T_al_P_swe_mr_sst_wet)
snowFraction_T_al_P_swe_mr_sst_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_sst_wet.npy')
#np.save('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_sst_cc_wet',snowFraction_T_al_P_swe_mr_sst_cc_wet)
snowFraction_T_al_P_swe_mr_sst_cc_wet_obj = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction_T_al_P_swe_mr_sst_cc_wet.npy')

#%%

snowFraction_h_swe_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe2_dry_obj],ignore_index=True)
snowFraction_h_swe_mr_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_dry_obj],ignore_index=True)
snowFraction_h_swe_mr_sst_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_sst_dry_obj],ignore_index=True)
snowFraction_h_swe_mr_sst_cc_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_sst_cc_dry_obj],ignore_index=True)

snowFraction_T_swe_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe2_dry_obj],ignore_index=True)
snowFraction_T_swe_mr_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_dry_obj],ignore_index=True)
snowFraction_T_swe_mr_sst_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_sst_dry_obj],ignore_index=True)
snowFraction_T_swe_mr_sst_cc_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_sst_cc_dry_obj],ignore_index=True)

snowFraction_T_al_swe_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe2_dry_obj],ignore_index=True)
snowFraction_T_al_swe_mr_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_dry_obj],ignore_index=True)
snowFraction_T_al_swe_mr_sst_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_sst_dry_obj],ignore_index=True)
snowFraction_T_al_swe_mr_sst_cc_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_sst_cc_dry_obj],ignore_index=True)

snowFraction_T_al_P_swe_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe2_dry_obj],ignore_index=True)
snowFraction_T_al_P_swe_mr_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_dry_obj],ignore_index=True)
snowFraction_T_al_P_swe_mr_sst_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_sst_dry_obj],ignore_index=True)
snowFraction_T_al_P_swe_mr_sst_cc_dry = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_sst_cc_dry_obj],ignore_index=True)



snowFraction_h_swe_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe2_wet_obj],ignore_index=True)
snowFraction_h_swe_mr_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_wet_obj],ignore_index=True)
snowFraction_h_swe_mr_sst_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_sst_wet_obj],ignore_index=True)
snowFraction_h_swe_mr_sst_cc_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_h_swe_mr_sst_cc_wet_obj],ignore_index=True)

snowFraction_T_swe_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe2_wet_obj],ignore_index=True)
snowFraction_T_swe_mr_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_wet_obj],ignore_index=True)
snowFraction_T_swe_mr_sst_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_sst_wet_obj],ignore_index=True)
snowFraction_T_swe_mr_sst_cc_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_swe_mr_sst_cc_wet_obj],ignore_index=True)

snowFraction_T_al_swe_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe2_wet_obj],ignore_index=True)
snowFraction_T_al_swe_mr_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_wet_obj],ignore_index=True)
snowFraction_T_al_swe_mr_sst_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_sst_wet_obj],ignore_index=True)
snowFraction_T_al_swe_mr_sst_cc_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_swe_mr_sst_cc_wet_obj],ignore_index=True)

snowFraction_T_al_P_swe_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe2_wet_obj],ignore_index=True)
snowFraction_T_al_P_swe_mr_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_wet_obj],ignore_index=True)
snowFraction_T_al_P_swe_mr_sst_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_sst_wet_obj],ignore_index=True)
snowFraction_T_al_P_swe_mr_sst_cc_wet = pd.concat([pd.DataFrame(k) for k in snowFraction_T_al_P_swe_mr_sst_cc_wet_obj],ignore_index=True)
...
d11 = [snowFraction_h_swe_wet[0],snowFraction_T_swe_wet[0], 
       snowFraction_T_al_swe_wet[0],snowFraction_T_al_P_swe_wet[0],
       snowFraction_h_swe_dry[0],snowFraction_T_swe_dry[0],
       snowFraction_T_al_swe_dry[0],snowFraction_T_al_P_swe_dry[0],
       
       snowFraction_h_swe_mr_wet[0],snowFraction_T_swe_mr_wet[0],
       snowFraction_T_al_swe_mr_wet[0],snowFraction_T_al_P_swe_mr_wet[0],
       snowFraction_h_swe_mr_dry[0],snowFraction_T_swe_mr_dry[0],
       snowFraction_T_al_swe_mr_dry[0],snowFraction_T_al_P_swe_mr_dry[0],
       
       snowFraction_h_swe_mr_sst_cc_wet[0],snowFraction_T_swe_mr_sst_cc_wet[0],
       snowFraction_T_al_swe_mr_sst_cc_wet[0],snowFraction_T_al_P_swe_mr_sst_cc_wet[0],
       snowFraction_h_swe_mr_sst_cc_dry[0],snowFraction_T_swe_mr_sst_cc_dry[0],
       snowFraction_T_al_swe_mr_sst_cc_dry[0],snowFraction_T_al_P_swe_mr_sst_cc_dry[0],   
       ]
...
bp3['boxes'][0].set(linewidth=8, facecolor = 'mediumvioletred', hatch = '*')
bp3['boxes'][1].set(linewidth=8, facecolor = 'mediumvioletred', hatch = '*')
bp3['boxes'][2].set(linewidth=8, facecolor = 'mediumvioletred', hatch = '*')
bp3['boxes'][3].set(linewidth=8, facecolor = 'mediumvioletred', hatch = '*')
bp3['boxes'][4].set(linewidth=8, facecolor = 'plum', hatch = '*')
bp3['boxes'][5].set(linewidth=8, facecolor = 'plum', hatch = '*')
bp3['boxes'][6].set(linewidth=8, facecolor = 'plum', hatch = '*')
bp3['boxes'][7].set(linewidth=8, facecolor = 'plum', hatch = '*')

bp3['boxes'][8].set(linewidth=8, facecolor = 'mediumvioletred', hatch = '/')
bp3['boxes'][9].set(linewidth=8, facecolor = 'mediumvioletred', hatch = '/')
bp3['boxes'][10].set(linewidth=8, facecolor = 'mediumvioletred', hatch = '/')
bp3['boxes'][11].set(linewidth=8, facecolor = 'mediumvioletred', hatch = '/')
bp3['boxes'][12].set(linewidth=8, facecolor = 'plum', hatch = '/')
bp3['boxes'][13].set(linewidth=8, facecolor = 'plum', hatch = '/')
bp3['boxes'][14].set(linewidth=8, facecolor = 'plum', hatch = '/')
bp3['boxes'][15].set(linewidth=8, facecolor = 'plum', hatch = '/')

bp3['boxes'][16].set(linewidth=8, facecolor = 'mediumvioletred', hatch = 'o')
bp3['boxes'][17].set(linewidth=8, facecolor = 'mediumvioletred', hatch = 'o')
bp3['boxes'][18].set(linewidth=8, facecolor = 'mediumvioletred', hatch = 'o')
bp3['boxes'][19].set(linewidth=8, facecolor = 'mediumvioletred', hatch = 'o')
bp3['boxes'][20].set(linewidth=8, facecolor = 'plum', hatch = 'o')
bp3['boxes'][21].set(linewidth=8, facecolor = 'plum', hatch = 'o')
bp3['boxes'][22].set(linewidth=8, facecolor = 'plum', hatch = 'o')
bp3['boxes'][23].set(linewidth=8, facecolor = 'plum', hatch = 'o')
...
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/snow_rain_sep/snowFraction3.png')
