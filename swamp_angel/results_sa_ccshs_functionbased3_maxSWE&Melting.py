...
nvolfracIce0 = pd.concat(readSomePartofVariableDatafromNcfilesDatasetasDF(av_all,'mLayerVolFracIce',hru_names_df[0],Apareto_model_param[0]), axis=1)
nvolfracliq0 = pd.concat(readSomePartofVariableDatafromNcfilesDatasetasDF(av_all,'mLayerVolFracLiq',hru_names_df[0],Apareto_model_param[0]), axis=1)
nheight0 = pd.concat(readSomePartofVariableDatafromNcfilesDatasetasDF(av_all,'mLayerHeight',hru_names_df[0],Apareto_model_param[0]), axis=1)
nlayerTemp0 =  pd.concat(readSomePartofVariableDatafromNcfilesDatasetasDF(av_all,'mLayerTemp',hru_names_df[0],Apareto_model_param[0]), axis=1)
nsnow0 =  pd.concat(readSomePartofVariableDatafromNcfilesDatasetasDF(av_all,'nSnow',hru_names_df[0],Apareto_model_param[0]), axis=1)
nlayer0 = pd.concat(readSomePartofVariableDatafromNcfilesDatasetasDF(av_all,'nLayers',hru_names_df[0],Apareto_model_param[0]), axis=1)
#%%
...
#%% number of snowlayer
nsnow03260 = pd.DataFrame(readSpecificDatafromAllHRUs(nsnow0,Apareto_model_param[0],4236)).T; nsnow03260.columns = Apareto_model_param[0]
...
sumlayer03260 = pd.DataFrame(sumBeforeSpecificDatafromAllHRUs(nlayer0,Apareto_model_param[0],4236)).T; sumlayer03260.columns = Apareto_model_param[0]
...
snowlayertemp0326 = snowLayerAttributeforSpecificDate(nlayerTemp0,Apareto_model_param[0],sumlayer03260,nsnow03260)

#%% volumetric fraction of ice in snow layers
volfracIce0326 = snowLayerAttributeforSpecificDate(nvolfracIce0,Apareto_model_param[0],sumlayer03260,nsnow03260)

#%% volumetric fraction of liquid in snow layers
volfracLiq0326 = snowLayerAttributeforSpecificDate(nvolfracliq0,Apareto_model_param[0],sumlayer03260,nsnow03260)

#%% height of each snow layer
height0326 = snowLayerAttributeforSpecificDate(nheight0,Apareto_model_param[0],sumlayer03260,nsnow03260)
...
coldcontentcrit = [abs(values) for values in mySubtract(coldcontent0326,cc0326)]
