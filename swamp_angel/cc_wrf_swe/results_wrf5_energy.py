...
sms_T_alimeStep_T_al_dry = pd.DataFrame(start_meltSeason_T_al_dry)*24.; sms_T_alimeStep_T_al_dry.index = av_swe_df_T_al.columns[1:]
sms_T_alimeStep_T_al_wet = pd.DataFrame(start_meltSeason_T_al_wet)*24 + 8760.; sms_T_alimeStep_T_al_dry.index = av_swe_df_T_al.columns[1:]
...
sms_T_al_PimeStep_T_al_P_dry = pd.DataFrame(start_meltSeason_T_al_P_dry)*24.; sms_T_al_PimeStep_T_al_P_dry.index = av_swe_df_T_al_P.columns[1:]
sms_T_al_PimeStep_T_al_P_wet = pd.DataFrame(start_meltSeason_T_al_P_wet)*24 + 8760.; sms_T_al_PimeStep_T_al_P_dry.index = av_swe_df_T_al_P.columns[1:]
