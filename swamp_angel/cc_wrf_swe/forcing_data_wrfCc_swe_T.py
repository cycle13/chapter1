...
for csv_counter3 in range (162):
     hruid_p12.append(float(params3[csv_counter3][0]))

hruid_p13 = []
for csv_counter4 in range (len(params3)):
     hruid_p13.append(float(params3[csv_counter4][1]))
...
with open("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf_swe/swamp_angel_forcingdata2_corrected_precipCalib_final_L_tempWrf.csv") as safd:
...
#%% make new nc file
new_fc_sa = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf_swe/SwampAngel_forcingD.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
new_fc_sa.close()
#%%
testfd = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf_swe/SwampAngel_forcingD.nc")
atemp =  testfd.variables['airtemp'][:]
# read out variables, data types, and dimensions of original forcing netcdf
