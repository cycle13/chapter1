...
params_sa = hruid_dic['lsh'] 
hruidxID = hruid_dic['lsh']
hru_num = np.size(hruidxID)

#%% #Swamp Angel forcing data
with open("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf_swe/swamp_angel_forcingdata2_corrected_precipCalib_final_L_wrf_T_al_p.csv") as safd:
...
#%% make new nc file
new_fc_sa = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf_swe/SwampAngel_forcingD_lsh_T_al_P.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
new_fc_sa.close()
#%%
testfd = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf_swe/SwampAngel_forcingD_lsh_T_al_P.nc")
