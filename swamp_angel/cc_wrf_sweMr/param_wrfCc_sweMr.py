...
#%%  all parameters
with open("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/STAR_out_P13_233_L_lstCC.csv") as safd:
...
paramfile = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/summa_zParamTrial_variableDecayRate_sa.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
...
local_atrbt = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/summa_zLocalAttributes_swampAngel.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
local_atrbt.close()
#%%
lacheck = Dataset('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/summa_zLocalAttributes_swampAngel.nc')
...
in_condi = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/summa_zInitialCond.nc",'w',format='NETCDF3_CLASSIC')
...
in_condi.close()
#%%
iccheck = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/summa_zInitialCond.nc")
