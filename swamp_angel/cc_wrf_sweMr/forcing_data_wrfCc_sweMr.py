...
with open("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/swamp_angel_forcingdata2_corrected_precipCalib_final_L_tempWrf.csv") as safd:
...
#%% make new nc file
new_fc_sa = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/SwampAngel_forcingD.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
new_fc_sa.close()
#%%
testfd = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/cc_wrf/SwampAngel_forcingD.nc")
