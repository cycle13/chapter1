...
p6 = [0.5,0.5] #heightCanopyTop
p7 = [0.01,0.01] #heightCanopyBottom
p8 = [0.9,0.9] #throughfallScaleSnow
p9 = [55,55] #newSnowDenMin

p10 =[500000,1000000] #[500000, 1000000, 1300000] ##albedoDecayRate |       1.0d+6 |       0.1d+6 |       5.0d+6 
...
paramfile = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/testVegFunctionsImpact/summa_zParamTrial_variableDecayRate_sa_vegTest.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
...
param_nam_list = ['LAIMIN','LAIMAX','winterSAI','summerLAI','rootingDepth','heightCanopyTop','heightCanopyBottom',
                  ...
                  'albedoMaxNearIR', 'albedoMinNearIR','z0Snow', 'albedoRefresh', 'mw_exp']#, 'fixedThermalCond_snow'] 
...
paramfile.close()
#%% 
varcheck = Dataset ('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/testVegFunctionsImpact/summa_zParamTrial_variableDecayRate_sa_vegTest.nc')
...
local_atrbt = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/testVegFunctionsImpact/summa_zLocalAttributes_swampAngel_vegTest.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
local_atrbt.close()
#%%
lacheck = Dataset('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/testVegFunctionsImpact/summa_zLocalAttributes_swampAngel_vegTest.nc')
...
in_condi = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/testVegFunctionsImpact/summa_zInitialCond_vegTest.nc",'w',format='NETCDF3_CLASSIC')
...
in_condi.close()
#%%
iccheck = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/testVegFunctionsImpact/summa_zInitialCond_vegTest.nc")
