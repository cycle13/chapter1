...
years = ['2007','2008']
out_names = ["mcdln","mcdlnl","mcdlu","mcseb","mcsec","mcsen","mcsenl","mcseu","mcslb","mcslc",#base1
             "mcsln","mcslnl","mcslu","mrdeb","mrdec","mrden","mrdenl","mrdeu","mrdlb","mrdlc",
             "mrdln","mrdlnl","mrdlu","mrseb","mrsec","mrsen","mrsenl","mrseu","mrslb","mrslc",
             "mrsln","mrslnl","mrslu","mvdeb","mvdec","mvden","mvdenl","mvdeu","mvdlb","mvdlc",
             "mvdln","mvdlnl","mvdlu","mvseb","mvsec","mvsen","mvsenl","mvseu","mvslb","mvslc",
             "mvsln","mvslnl","mvslu","scdeb","scdec","scden","scdenl","scdeu","scdlb","scdlc",
             "scdln","scdlnl","scdlu","scseb","scsec","scsen","scsenl","scseu","scslb","scslc",
             "scsln","scslnl","scslu","srdeb","srdec","srden","srdenl","srdeu","srdlb","srdlc",
             "srdln","srdlnl","srdlu","srseb","srsec","srsen","srsenl","srseu","srslb","srslc",
             "srsln","srslnl","srslu","svdeb","svdec","svden","svdenl","svdeu","svdlb","svdlc",
             "svdln","svdlnl","svdlu","svseb","svsec","svsen","svsenl","svseu","svslb","svslc",
             "svsln","svslnl","svslu","mcdeb","mcdec","mcden","mcdenl","mcdeu","mcdlb","mcdlc"]
...
for hru in range (1428,1440):#,2len(hru_names_df[0])
    print hru_names_df[0][hru]
    plt.plot(av_swe_df[hru_names_df[0][hru]], linewidth=4)
   
plt.plot(obs_swe, 'ok', markersize=15)
print (hru_names_df[0][10:13])
print (hru_names_df[0][13:16])
...
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/vegImpact/swe_sa_vegImpat_goodVeg2.png')
...
dosd_residual_df2008min = np.min(dosd_residual_df2008)
dosd_residual_df2008minM = np.min(dosd_residual_df2008min)
