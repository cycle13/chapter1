...
nsnowG2 = []
for dfs in av_all:
    nsnowG2.append(pd.DataFrame(dfs['nSnow'][:][4784]))
    nsnowG2.append(pd.DataFrame(dfs['nSnow'][:][4907]))
    nsnowG2.append(pd.DataFrame(dfs['nSnow'][:][5121]))
...
nlayerG2 = []
for dfs in av_all:
    nlayerG2.append(pd.DataFrame(dfs['nLayers'][:][4784]))
    nlayerG2.append(pd.DataFrame(dfs['nLayers'][:][4907]))
    nlayerG2.append(pd.DataFrame(dfs['nLayers'][:][5121]))
#%%
