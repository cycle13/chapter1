...
#nsnowG1 = []
#for dfs in av_all:
#    nsnowG1.append(pd.DataFrame(dfs['nSnow'][:][3902]))
#    nsnowG1.append(pd.DataFrame(dfs['nSnow'][:][4068]))
#    nsnowG1.append(pd.DataFrame(dfs['nSnow'][:][4236]))
#    nsnowG1.append(pd.DataFrame(dfs['nSnow'][:][4404]))
#    
#nlayerG1 = []
#for dfs in av_all:
#    nlayerG1.append(pd.DataFrame(dfs['nLayers'][:][3902]))
#    nlayerG1.append(pd.DataFrame(dfs['nLayers'][:][4068]))
#    nlayerG1.append(pd.DataFrame(dfs['nLayers'][:][4236]))
#    nlayerG1.append(pd.DataFrame(dfs['nLayers'][:][4404]))

nsnow0418 = []
nsnow0423 = []
nsnow0502 = []
for dfs in av_all:
    nsnow0418.append(pd.DataFrame(dfs['nSnow'][:][4784]))
    nsnow0423.append(pd.DataFrame(dfs['nSnow'][:][4907]))
    nsnow0502.append(pd.DataFrame(dfs['nSnow'][:][5121]))
    
nlayer0418 = []
nlayer0423 = []
nlayer0502 = []
for dfs in av_all:
    nlayer0418.append(pd.DataFrame(dfs['nLayers'][:][4784]))
    nlayer0423.append(pd.DataFrame(dfs['nLayers'][:][4907]))
    nlayer0502.append(pd.DataFrame(dfs['nLayers'][:][5121]))

sumlayer0418 = []
sumlayer0423 = []
sumlayer0502 = []
for dfs in av_all:
    sumlayer0418.append(pd.DataFrame(sum(dfs['nLayers'][:][0:4784])))
    sumlayer0423.append(pd.DataFrame(sum(dfs['nLayers'][:][0:4907])))
    sumlayer0502.append(pd.DataFrame(sum(dfs['nLayers'][:][0:5121])))      
...
nf = 0
hru = 0
for nf in range (np.size(av_all)):
    for hru in range (hru_num):
        nlayertemp0418.append(nlayerTemp[nf][hru][sumlayer0418[nf][0][hru]:sumlayer0418[nf][0][hru]+nsnow0418[nf][0][hru]])
#nlayerTemp[0][0][sumlayerG2:sumlayerG2+nlayerG2]
