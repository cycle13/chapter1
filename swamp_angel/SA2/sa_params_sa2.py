...
p7 = [270000, 360000, 1000000] #albedoDecayRate ??????????????????????
p8 = [0.8000, 0.90000, 0.95000] #albedoMaxVisible 
p9 = [0.6000, 0.68000, 0.75000] #albedoMinVisible  
p10 = [0.5500, 0.65000, 0.70000] #albedoMaxNearIR
p11 = [0.2000, 0.30000, 0.40000] #albedoMinNearIR
p12 = [1]#, 3, 7] #albedoRefresh
...
p25 = [100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0,
       ...
       100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0] #constSnowDen 55 56 57 
p13 = [0.35]# 0.2, 0.35 , 0.6] #fixedThermalCond_snow
p14 = [2]#, 2, 3, 4] #mw_exp
p15 = [0.003]#, 0.001, 0.002, 0.004] #z0Snow
...
paramfile = Dataset("summa_zParamTrial_variableDecayRate_SA_sa2_1213.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
