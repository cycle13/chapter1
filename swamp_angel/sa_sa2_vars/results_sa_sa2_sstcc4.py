...
av_vfl_df = readVariablefromMultipleNcfilesDatasetasDF(av_all,'mLayerVolFracLiq',hru_names_df,hruidxID,out_names)
...
delta_sstRate_df_mean_r_bestSWE_bestMR_bestSDD = sst_ratep2a_delta_perc[ind_df_mean_perc_bestSWE_bestMR_bestSDD_bestSST]
