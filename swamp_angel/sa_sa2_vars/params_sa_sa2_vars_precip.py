...
#%%  all parameters
with open("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/STAR_out_precip.csv") as safd:
...
paramfile = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/summa_zParamTrial_variableDecayRate_precip.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file

hruidxID = list(np.arange(10000,10001))
...
print (paramfile.variables['LAIMIN'][:])
aaa = paramfile.variables['frozenPrecipMultip'][:]
paramfile.close()
#%% 
varcheck = Dataset ('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/summa_zParamTrial_variableDecayRate_precip.nc')
...
print varcheck.variables['frozenPrecipMultip'][:] #critRichNumber
...
local_atrbt = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/summa_zLocalAttributes_swampAngel_precip.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
local_atrbt.close()
#%%
lacheck = Dataset('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/summa_zLocalAttributes_swampAngel_precip.nc')
...
in_condi = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/summa_zInitialCond_precip.nc",'w',format='NETCDF3_CLASSIC')
...
in_condi.close()
#%%
iccheck = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/summa_zInitialCond_precip.nc")
