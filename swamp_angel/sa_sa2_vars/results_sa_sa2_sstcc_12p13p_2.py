...
#%% observed corrected snow surface temp in the morning
...
from allNcFiles_sa2_stcc import av_ncfiles13p
...
dosd_residual_df_sum_r_bestSWE_bestMR_bestsdd = dosd_residual_df_sum_r_bestSWE_bestMR[ind_df_mean_perc_bestSWE_bestMR_bestSDD]
...
delta_sstRate_df_sum_r_bestSWE_bestMR_bestSDD_bestSST = delta_sstRate_df_mean_r_bestSWE_bestMR_bestSDD[ind_df_mean_perc_bestSWE_bestMR_bestSDD_bestSST_bestSstRate]
...
for hru4 in ind_df_mean_perc_bestSWE_bestMR_bestSDD_bestSST_bestSstRate_bestCC:#
    plt.plot(np.arange(1,len(coldcontent_p2a_df)+1),coldcontent_p2a_df[hru4], color  = 'plum', marker = 'o', markersize = 80, linestyle='') ##, color  = 'green', linewidth=4, 

plt.plot(np.arange(1,len(coldcontent_p2a_df)+1),coldcontent_obs_p2a_df, color  = 'k', marker = 'o', markersize = 80, linestyle='') #s =3000, sst_obs_morn_ablation_df.index, linewidth=4[0:16], markersize=15
plt.yticks(fontsize=40)
plt.xlabel('Time 2006-2008', fontsize=40)
saax4.set_ylabel('Cold content (Mj m-3 K-1) perior to the ablation period', fontsize=40)
...
#%% observed not-corrected snow surface temp in the morning
sst_obs_df20= pd.DataFrame(sst_obs_df0.values, columns = ['observed_snowSurfaceTemp']) 

sst_obs_morn_df0 = pd.DataFrame((sst_obs_df0['observed_snowSurfaceTemp']['2006-10-01 03:00':'2008-06-13 03:00':24].values+
                                 sst_obs_df0['observed_snowSurfaceTemp']['2006-10-01 04:00':'2008-06-13 04:00':24].values+
                                 sst_obs_df0['observed_snowSurfaceTemp']['2006-10-01 05:00':'2008-06-13 05:00':24].values+
                                 sst_obs_df0['observed_snowSurfaceTemp']['2006-10-01 06:00':'2008-06-13 06:00':24].values)/4.)
sst_obs_morn_df0.index = snowdepth_obs_df.index[0:len(sst_obs_morn_df0)]

sst_obs_morn_df20 = pd.DataFrame(sst_obs_morn_df0.values, columns = ['observed_snowSurfaceTemp_morning']) 
sst_obs_morn_df20.set_index(indx_sd[0:622],inplace=True)

sst_obs_morn2007_ablation_df0 = sst_obs_morn_df0[0]['2007-04-18':'2007-05-23'] #perior_ablationPeriod = ['2007-04-18','2007-04-23','2007-05-02','2007-05-09','2007-05-16','2007-05-23']#,
sst_obs_morn2008_ablation_df0 = sst_obs_morn_df0[0]['2008-04-14':'2008-05-06'] #perior_ablationPeriod = ['2008-04-14 14:45','2008-04-22 12:30','2008-04-28 12:30','2008-05-06 09:15']#,
sst_obs_morn_ablation_df0 = pd.concat([sst_obs_morn2007_ablation_df0,sst_obs_morn2008_ablation_df0])

sst_obs_5am2007_ablation_df0 = sst_obs_df0['observed_snowSurfaceTemp']['2007-04-18 05:00':'2007-05-23 06:00':24] #perior_ablationPeriod = ['2007-04-18','2007-04-23','2007-05-02','2007-05-09','2007-05-16','2007-05-23']#,
sst_obs_5am2008_ablation_df0 = sst_obs_df0['observed_snowSurfaceTemp']['2008-04-14 05:00':'2008-05-06 06:00':24] #perior_ablationPeriod = ['2008-04-14 14:45','2008-04-22 12:30','2008-04-28 12:30','2008-05-06 09:15']#,
sst_obs_5am_ablation_df0 = pd.concat([sst_obs_5am2007_ablation_df0,sst_obs_5am2008_ablation_df0])

sst_obs_3pm2007_ablation_df0 = sst_obs_df0['observed_snowSurfaceTemp']['2007-04-18 15:00':'2007-05-23 16:00':24] #perior_ablationPeriod = ['2007-04-18','2007-04-23','2007-05-02','2007-05-09','2007-05-16','2007-05-23']#,
sst_obs_3pm2008_ablation_df0 = sst_obs_df0['observed_snowSurfaceTemp']['2008-04-14 15:00':'2008-05-06 16:00':24] #perior_ablationPeriod = ['2008-04-14 14:45','2008-04-22 12:30','2008-04-28 12:30','2008-05-06 09:15']#,
sst_obs_3pm_ablation_df0 = pd.concat([sst_obs_3pm2007_ablation_df0,sst_obs_3pm2008_ablation_df0])

#plot mornind sst corrected vs. original
safig5, saax5 = plt.subplots(1,1, figsize=(30,20))#
plt.scatter(np.arange(1,len(sst_obs_morn_ablation_df0)+1),sst_obs_morn_ablation_df0, s =2000, color  = 'tomato') ##, linewidth=4
plt.scatter(np.arange(1,len(sst_obs_morn_ablation_df)+1),sst_obs_morn_ablation_df-273.16, s =2000, color  = 'green') #sst_obs_morn_ablation_df.index, linewidth=4[0:16], markersize=15
plt.yticks(fontsize=40)
plt.xlabel('Prior to ablation period in 2007 and 2008', fontsize=40)
saax5.set_ylabel('snow surface temperature before sunrise(C)', fontsize=40)
plt.xticks(np.arange(1,len(sst_obs_morn_ablation_df)+1)[::7],setXtick[::7],rotation=25, fontsize=40)# sax[::2000], sa_xticks[::2000], 
plt.legend(['observed','corrected'], fontsize=50)
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/sa2_bestSweSD/sa_sa2_sstMorn_cor.png')

safig6, saax6 = plt.subplots(1,1, figsize=(30,20))#
plt.scatter(np.arange(1,len(sst_obs_5am_ablation_df0)+1),sst_obs_5am_ablation_df0, s =2000, color  = 'hotpink') ##, linewidth=4
plt.scatter(np.arange(1,len(sst_obs_5am_ablation_df)+1),sst_obs_5am_ablation_df-273.16, s =2000, color  = 'lightseagreen') #sst_obs_morn_ablation_df.index, linewidth=4[0:16], markersize=15
plt.yticks(fontsize=40)
plt.xlabel('Prior to ablation period in 2007 and 2008', fontsize=40)
saax6.set_ylabel('snow surface temperature at 5 am (C)', fontsize=40)
plt.xticks(np.arange(1,len(sst_obs_5am_ablation_df0)+1)[::7],setXtick[::7],rotation=25, fontsize=40)# sax[::2000], sa_xticks[::2000], 
plt.legend(['observed','corrected'], fontsize=50)
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/sa2_bestSweSD/sa_sa2_sst5am_cor.png')

safig7, saax7 = plt.subplots(1,1, figsize=(30,20))#
plt.scatter(np.arange(1,len(sst_obs_3pm_ablation_df0)+1),sst_obs_3pm_ablation_df0, s =2000, color  = 'palevioletred') ##, linewidth=4
plt.scatter(np.arange(1,len(sst_obs_3pm_ablation_df)+1),sst_obs_3pm_ablation_df-273.16, s =2000, color  = 'palegreen') #sst_obs_morn_ablation_df.index, linewidth=4[0:16], markersize=15
plt.yticks(fontsize=40)
plt.xlabel('Prior to ablation period in 2007 and 2008', fontsize=40)
saax7.set_ylabel('snow surface temperature at 3 pm (C)', fontsize=40)
plt.xticks(np.arange(1,len(sst_obs_5am_ablation_df0)+1)[::7],setXtick[::7],rotation=25, fontsize=40)# sax[::2000], sa_xticks[::2000], 
plt.legend(['observed','corrected'], fontsize=50)
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/sa2_bestSweSD/sa_sa2_sst3am_cor.png')

safig8, saax8 = plt.subplots(1,1, figsize=(30,20))#
plt.plot(sst_obs_df0, color  = 'orangered', linewidth=4) ##
plt.plot(sst_obs_df-273.16, color  = 'springgreen', linewidth=4) #sst_obs_morn_ablation_df.index, linewidth=4[0:16], markersize=15
plt.yticks(fontsize=40)
plt.xlabel('water year 2007-2008', fontsize=40)
saax8.set_ylabel('snow surface temperature', fontsize=40)
plt.xticks(rotation=25, fontsize=40)# sax[::2000], sa_xticks[::2000], 
plt.legend(['observed','corrected'], fontsize=50)
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/sa_sa2_vars/sa2_bestSweSD/sa_sa2_sst_cor.png')
