...
#%% make new nc file
new_fc_sa = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/vegImpact/SwampAngel_forcingD_vegImpact.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
new_fc_sa.close()
#%%
testfd = Dataset("C:/1UNRuniversityFolder/Dissertation/Chapter 1-Snowmelt/swamp_angel/vegImpact/SwampAngel_forcingD_vegImpact.nc")
